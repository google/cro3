export declare function requestSerialAddClickEvent(fn: () => Promise<void>): void;
...
export declare function selectDUTSerialAddClickEvent(fn: () => Promise<void>): void;
export declare function executeScriptAddClickEvent(fn: () => Promise<void>): void;
export declare function formAddSubmitEvent(fn: (e: Event) => Promise<void>): void;
export declare function inputAddKeydownEvent(fn: (e: KeyboardEvent) => Promise<void>): void;
...
export declare function dropZoneAddDragoverEvent(fn: (evt: DragEvent) => void): void;
export declare function dropZoneAddDropEvent(fn: (evt: DragEvent) => void): void;
