...
from src.docker_libs.build_libs.cros_dut.container_prep\
  import CrosDutArtifactPrep  # noqa: E402 pylint: disable=import-error,wrong-import-position
...
class CrosDutDockerPrepper(BaseDockerPrepper):
  ...
  def prep_container(self):
    CrosDutArtifactPrep(chroot=self.chroot,
