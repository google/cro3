...
REGISTERED_BUILDS = {
    "android-provision": {
        "prepper": CommonServiceDockerPrepper,
        "cloud": False,
    },
    "cros-callbox": {"prepper": CrosCallBoxDockerPrepper, "cloud": False},
    "cros-dut": {"prepper": CommonServiceDockerPrepper, "cloud": False},
    "testplan": {"prepper": CommonServiceDockerPrepper, "cloud": False},
    "cros-provision": {"prepper": CommonServiceDockerPrepper, "cloud": False},
    "cros-fw-provision": {
        "prepper": CrosFWProvisionDockerPrepper,
        "cloud": False,
    },
    ...
    "cros-servod": {"prepper": CrosServodDockerPrepper, "cloud": False},
    "cros-publish": {"prepper": CrosPublishDockerPrepper, "cloud": False},
}
...
NON_CRITICAL = set(["cros-servod", "cros-publish"])
    ...
    while retries >= 0:
        try:
            ...
            if retries <= 0:
                ...
                print(
                    f"Build failed, will retry in {args.retry_wait} seconds:\n{e}"
                )
    ...
    for service in REGISTERED_BUILDS:
        ...
        if err:
            ...
            if service in NON_CRITICAL:
                print(
                    f"{service} is not marked as critical so builder will not fail."
                )
            else:
