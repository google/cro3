...
#else
    .gate = _GATE, .execute = _EXECUTE, .sub = NULL, .next = NULL,
...
opt_pass *_MAKE_PASS_NAME_PASS(void) { return new _PASS_NAME_PASS(); }
#else
struct opt_pass *_MAKE_PASS_NAME_PASS(void) { return &_PASS_NAME_PASS.pass; }
#endif
