...
INAS = [
    ...
    ('pac19next','0x10:3','PP1800_C0_RETIMER_S5',1.800,0.010,'rem',True),
    ('pac19next','0x11:0','PP3300_GSC_Z1',3.300,0.300,'rem',True),
    ('pac19next','0x11:1','PP1100_S0',1.100,0.020,'rem',True),
    ...
    ('pac19next','0x12:2','PP1800_S5_VDD_18_S5',1.800,0.003,'rem',True),
    ('pac19next','0x12:3','PP3300_SSD_S0',3.300,0.020,'rem',True),
    ('pac19next','0x13:0','PP3300_CAM_X',3.300,0.020,'rem',True),
    ('pac19next','0x13:1','PP1800_S5_VDDIO_AUDIO',1.800,0.050,'rem',True),
    ('pac19next','0x13:2','PP0750_VDD_MISC_S0',0.750,0.020,'rem',True),
    ('pac19next','0x13:3','PP0750_VDD_MISC_S5',0.750,0.020,'rem',True),
    ('pac19next','0x14:0','PP1050_CORE_HUB',1.050,0.010,'rem',True),
    ...
    ('pac19next','0x15:0','PP1800_S0_VDD_18',1.800,0.010,'rem',True),
    ('pac19next','0x15:1','PP1800_Z1',1.800,0.003,'rem',True),
    ('pac19next','0x15:2','PP3300_Z1',3.300,0.005,'rem',True),
    ('pac19next','0x15:3','PP3300_S0',3.300,0.005,'rem',True),
    ('pac19next','0x16:0','PP1800_EC_Z1',1.800,1.000,'rem',True),
    ('pac19next','0x16:1','PP1800_GSC_Z1',1.800,1.000,'rem',True),
    ('pac19next','0x16:2','PP5000_S5',5.000,0.005,'rem',True),
    ('pac19next','0x16:3','PP3300_EC_Z1',3.300,0.220,'rem',True),
    ...
    ('pac19next','0x18:0','PP1800_S0',1.800,0.003,'rem',True),
    ('pac19next','0x18:1','PP5000_KB_BL_S5',5.000,0.050,'rem',True),
    ('pac19next','0x18:2','PP3300_S5',3.300,0.200,'rem',True),
    ('pac19next','0x18:3','PP1800_S5',1.800,0.003,'rem',True),
    ('pac19next','0x19:0','PP3300_SD_S0',3.300,0.005,'rem',True),
    ('pac19next','0x19:0','PP1800_CPLD_Z1',1.800,1.000,'rem',True),
