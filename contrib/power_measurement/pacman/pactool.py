...
def main():
    ...
    list_parser = sub_parsers.add_parser(
        'list',
        help='List currently connected devices'
    )
    list_parser.set_defaults(command='list')

    provision_parser = sub_parsers.add_parser(
        'provision',
        help='Provisions a device'
    )
    ...
    erase_parser = sub_parsers.add_parser(
        'erase',
        help='Erases a provisioned device, unprovisioning it'
    )
    ...
    unbrick_parser.add_argument(
        'unbricker_url',
        help='FTDI URL for SPI interface'
    )
