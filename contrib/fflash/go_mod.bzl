...
def go_mod_dependencies():
    ...
    go_repository(
        name = "com_github_klauspost_readahead",
        importpath = "github.com/klauspost/readahead",
        sum = "h1:w4hQ3BpdLjBnRQkZyNi+nwdHU7eGP9buTexWK9lU7gY=",
        version = "v1.4.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:fpP/gByFs6US1ma53v7VxhvbJpO2Aapng6wabJ99MuI=",
        version = "v0.10.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:nEzRHNOazEST44vMvEwxGxnYGrzXEmxJmnti5mKSWTk=",
        version = "v0.0.0-20230126173853-a67bb567ff2e",
    )
