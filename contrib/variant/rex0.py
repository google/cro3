...
"""Define steps, package names, and directories for creating a Rex variant
...
fitimage_pkg = "coreboot-private-files-baseboard-rex"

# Directory for fitimage; append '~/trunk/src/'' in chroot, '~/chromiumos/src'
# outside
fitimage_dir = (
    "private-overlays/baseboard-rex-private/sys-boot/"
    "coreboot-private-files-baseboard-rex"
)

# Rex fitimages use csme-${VARIANT}.bin, not fitimage-${VARIANT}.bin
...
# MTL-U CSE Lite uses MFIT, not FIT
