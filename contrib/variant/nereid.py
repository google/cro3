...
# outside
fitimage_dir = ('private-overlays/chipset-adln-private/sys-boot/'
...
workon_pkgs = [
    ...
    fitimage_pkg, 'chromeos-zephyr', 'chromeos-config-bsp-private']
...
repo_upload_list = [
    step_names.CB_CONFIG, step_names.COMMIT_FIT, step_names.EC_IMAGE,
    step_names.FW_BUILD_CONFIG]
