...
topiclist = [
    ...
    ['chromeos',
     ['chromeos', 'security/chromiumos', 'COMMIT-QUEUE.ini', 'PRESUBMIT.cfg',
      'init', 'scripts', 'unblocked_terms.txt', '.gitignore', 'OWNERS',
      'DIR_METADATA']],
    ['mm',
     ['mm', 'include/linux/low-mem-notify.h',
      'include/linux/mm_metrics.h', 'include/linux/mm.h']],
    ['cros_ec',
    ...
    ['sound',
     ['sound', 'Documentation/devicetree/bindings/sound', 'include/sound',
      'include/uapi/sound']],
    ['block-fs',
     ['fs', 'include/linux/pstore', 'include/uapi/linux/fuse.h',
    ...
    ['arch',
     ['arch', 'kernel', 'lib',
      ...
      'arch/x86/configs/x86_64_arcvm_defconfig', 'virt/kvm']],
    ['drivers',
     ['drivers', 'Documentation/mmc', 'include/linux/mmc',
      'include/uapi/linux/mmc', 'include/linux/input',
      'include/linux/mfd', 'Documentation/ABI']],
    ['devicetree',
     ['Documentation/devicetree']],
    ['other',
     ['Documentation/x86', 'include/linux/sched',
      'security', 'include/linux/alt-syscall.h',
      'include/linux/syscalls.h', 'include/linux/nodemask.h',
      'include/linux/swapops.h', 'include/linux/cgroup.h',
      'include/trace','tools']],
]
