...
class TestPatchApplier(unittest.TestCase):
    ...
    def test_create_commit_message(self):
        ...
        msg = common.get_commit_message(
            kernel_path, common.get_sha(kernel_path)
        )
    ...
    def test_create_new_cherry_pick_branch(self):
        ...
        self.assertEqual(
            branch.rstrip(), bytes(expected_branch, encoding="utf-8")
        )
    ...
    def test_invalid_sha(self, _):
        ...
        self.assertRaises(
            common.CommonException, pa.apply_patch, sha, bug, kernel_versions
        )
    ...
    def test_invalid_linux_path(self):
        ...
        self.assertRaises(
            pa.PatchApplierException, pa.fetch_linux_kernel, kernel_path
        )
    ...
    def test_empty_env_variables(self):
        ...
        self.assertRaises(
            pa.PatchApplierException, pa.apply_patch, sha, bug, kernel_versions
        )
